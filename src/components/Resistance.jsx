    ...
    return (
        <div className='bg-resistance flex items-center justify-center bg-cover bg-center bg-[#070D37]  lg:pt-[153px] pb-[60px] sm:pb-[100px] lg:pb-[222px] mt-[-2px] '>
            ...
            <div className='container max-w-[1140px] mx-auto px-3 '>
                <div className=' border-[3px] rounded-[10px] border-[#39C6FD] pt-10 lg:pt-[65px] pb-10 mt-2 lg:pb-[89px] bg-[#070D37] px-10 lg:ps-[73px] lg:relative'>
                    ...
                    <p className='font-openSans font-normal text-base leading-[136%] text-white text-center lg:text-start mx-auto lg:mx-0 max-w-[582px] mb-6 lg:mb-[60px]'>Volutpat etiam tincidunt leo amet pulvinar. Adipiscing vestibulum enim ornare vestibulum. Mauris sit hendrerit interdum neque mattis enim egenisi.</p>
